...
import { updateDisease } from "../../api/diseases";
import { useDiseaseCategories } from "../../hooks/useDiseaseCategories";

export default function UpdateDiseaseModal({
  isOpen,
  onClose,
  disease,
  categories,
  ...
  useEffect(() => {
    if (disease && isOpen) {
      setFormData({
        ...
        preventionControl: disease.preventionControl || "",
        categoryId: Number(disease.categoryId) || null,
      });
      setImagePreview(disease.image || null);
    }
  }, [disease, isOpen]);
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-gray-800">Update Disease</h2>
            <button
              onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            {!imagePreview ? (
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-xs">
                  ...
                  {formData.image ? "Uploaded" : "Current image"}
                </div>
              </div>
            )}
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {isPending ? "Updating..." : "Update Disease"}
            </button>
          </div>
        </form>
      </div>
